			...
			{ props.header && <p className="AuthorPost__date">{ props.date } · { props.timeToRead } min de lectura</p>}
			{
				...
				<div className="Foot__AuthorPost__social">
					<a href="https://www.github.com/dantehemerson">
						<img alt="img" src="https://icongr.am/fontawesome/github.svg?color=ffffff&size=21" />
					</a>
					<a href="https://twitter.com/dantehemerson">
						<img alt="img" src="https://icongr.am/fontawesome/twitter.svg?color=ffffff&size=21" />
					</a>
					<a href="https://www.linkedin.com/in/dantehemerson">
						<img alt="img" src="https://icongr.am/fontawesome/linkedin.svg?color=ffffff&size=21" />
					</a>
					<a href="https://www.instagram.com/dantehemerson">
						<img alt="img" src="https://icongr.am/fontawesome/instagram.svg?color=ffffff&size=21" />
					</a>
				</div>
			}
		</div>
